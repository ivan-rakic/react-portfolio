...
class PublishMessage extends Component {
    ...
    updateText = even => this.setState({ text: event.target.value });
    ...
    render() {
        console.log('this publish message', this);
        ...
        return (
            <div>
                ...
                {' '}
                <button onKeyDown={this.handleKeyPress} onClick={this.publishMessage}>Publish it!</button>
            </div>
        );
    }
